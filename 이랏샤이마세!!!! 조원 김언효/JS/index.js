...
const options = {
  ...
  headers: {
    ...
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlZTgyYTZlZWU0OTQxZDVkOGIxZjgxNGU0YTAzZjExMCIsInN1YiI6IjY1OGU2YWE0ZDE4ZmI5MDFhY2FkMjVhNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.CA4Gu_fnD1-hEMdv2Ei_x9YBmJUwey-Sw5cjeAVFcVw"
  }
};
...
function searchMovie() {
  ...
  cards.forEach((card) => {
    ...
    const isTitle = title.includes(searchInput);

    card.style.display = isTitle ? "flex" : "none";
